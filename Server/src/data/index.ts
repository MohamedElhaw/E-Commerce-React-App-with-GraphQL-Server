...
const products: Product[] = [
    ...
    new Product('Jacket')
        ...
        .setPrice(430)
        .addImages([
            'https://media.istockphoto.com/photos/black-leather-jacket-shot-from-front-and-back-isolated-on-white-picture-id1069165932',
            'https://media.istockphoto.com/photos/mans-blank-black-leather-jacket-frontisolated-on-white-wclipping-path-picture-id157440389',
            'https://media.istockphoto.com/photos/classic-black-leather-bikers-jacket-with-lining-shot-from-the-front-picture-id885931726',
        ])
